...
const messages = {
    en: {
        message: {
            ...
            yes: 'Yes',
            no: 'No',
            hintDoubleCheck: 'Double click to select all elements currently in the table',
            hintDoubleCheck2: 'Double click to deselect all elements currently in the table',
            ...
            addRole: 'Add Role',
            computerFound:' Computers found',
            companyFound: 'Companies found',
            roleFound: 'Roles found',
    ...
    fr: {
        message: {
            ...
            company: 'Companies',
            companySelect: 'Selectionner une entreprise',
            ...
            yes: 'Oui',
            no: 'Non',
            hintDoubleCheck: 'Double cliquer pour selectionner tous les elements de la table',
            hintDoubleCheck2: 'Double cliquer pour déselectionner tous les elements de la table',
            plsSelectCompany: 'Selectionnez une entreprise',
            commit: 'Envoyer',
            reset: 'Annuler',
            submit: 'Valider',
            ...
            list: 'Liste',
            connexionError: 'Erreur de connexion, mot de passe ou identifiant incorrect ',
            perPage: 'Par page',
            selectRole: 'Choisissez un role',
            addRole: 'Ajouter un Role',
            computerFound:' Ordinateurs trouvés',
            companyFound: 'Entreprises trouvées',
            roleFound: 'Roles trouvés',
            userFound: 'Utilisateurs trouvés',
            companyDatabase: 'Base de donnée des entreprises',
